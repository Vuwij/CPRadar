...
'''
This is a Python script which continuously plots the center frequency for the signal from various receive antennas (transmitted by a single, constant transmit antenna that can be specified in the code)  
'''
