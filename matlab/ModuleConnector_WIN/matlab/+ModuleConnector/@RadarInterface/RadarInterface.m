...
%            status=calllib(this.lib_name,'nva_system_run_test',xep_instance,uint8(test_code),data_lengthPtr,dataPtr);
    ...
    %===================================================================================
        ...
        % TODO: TBD
        %     function status = set_parameter_file(this, X4M_instance,filename_length,data_length,filenamePtr,dataPtr)
        ...
        %       status = calllib(this.lib_name,'nva_set_parameter_file', X4M_instance,filename_length,data_length,filenamePtr,dataPtr);
        %     %int set_parameter_file(uint32_t filename_length, uint32_t data_length, const char * filename, const char * data)
        %     end
        % TODO: TBD
