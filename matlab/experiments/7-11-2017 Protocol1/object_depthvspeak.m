...
%Make sure you update obtain_greatest_peak with object of interest at -10cm as the
%baseline
...
for freq = linspace(2,5,4)
    for i = linspace(-9,0,10)
            ...
            [peak_dist peak_amp] = obtain_greatest_peak_between('screw-3mm-1.5cm',height,int2str(freq),'949','1100',20,40);
